    ...
    <div id="appCapsule">
        ...
        <div class="section mt-4">
            ...
            <div class="transactions">
                ...
                ?>
                <!-- item -->
                <a href="transaction-detail.php?id= <?php echo $rows["id"]; ?>" class="item">
                    <div class="detail">
                        <img src="assets/img/sample/brand/send.png" alt="img" class="image-block imaged w32">
                        <div>
                            <strong><?php echo $rows['acc_name']; ?></strong>
                            <p><?php echo $rows['tran_type']; ?></p>
                        </div>
                    </div>
                    <div class="right"> 
                        <?php
                            ...
                            $transaction = $rows['tran_type'];
                            $tran_type = 'Funds Transfer';

                            if ($tran_type == $transaction) {
                                // code...
                                echo "<div class=\"price text-danger\"> - $$new_amount</div>";
                            }else{
                                echo "<div class=\"price text-success\"> + $ $new_amount</div>";
                            }
                        ?>                        
                    </div>
                </a>
