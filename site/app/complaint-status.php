...
<head>
    ...
    <title>Alat - Complaint Status</title>
...
<body>
    ...
    <div class="appHeader">
        ...
        <div class="pageTitle">Chech Complaint Status</div>
        <div class="right">
        </div>
    </div>
    <!-- * App Header -->
    ...
    <div id="appCapsule">
        ...
        <div class="section mt-2">
            <div class="section-title">Enter Case ID</div>
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                            <div class="form-group basic animated">
                                <div class="input-wrapper">
                                    ...
                                    <input type="text" class="form-control" name="id" placeholder="Reference ID">
                                    <i class="clear-input">
