...
<head>
    ...
    <title>Alat - Complaints Management</title>
...
<body>
    ...
    <div class="appHeader">
        ...
        <div class="pageTitle">Select Category</div>
        <div class="right">
        </div>
    </div>
    <!-- * App Header -->
    ...
    <div id="appCapsule">
        ...
        <div class="section mt-2">
            <div class="card">
                <ul class="listview flush transparent image-listview">
                    <li>
                        <a href="e-channel-complaint.php" class="item">
        ...
        <div class="section mt-2">
            <div class="card">
                <ul class="listview flush transparent image-listview">
                    <li>
                        <a href="complaint-status.php" class="item">
                            <div class="icon-box bg-primary">
        ...
        <div class="section mt-2"> 
            <div class="row">
                ...
                <div class="col-sm-10">
                    Please wait 24 hours after an issue has occurred before logging the complaint to allow for automatic reversal
                </div>
            </div>
        </div>        
        <br>                
