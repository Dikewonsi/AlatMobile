...
<head>
    ...
    <title>Alat - Confirm Cheque</title>
    <meta name="description" content="Zaphir Mobile Bank">
    <meta name="keywords"
...
<body>
    ...
    <div class="appHeader">
        ...
        <div class="pageTitle">Confirm Cheque</div>
        <div class="right">
        </div>
    </div>
    <!-- * App Header -->
    ...
    <div id="appCapsule">
        ...
        <div class="section mt-2">
            <div class="section-title">Please enter document number, security number, amount and beneficiary name</div>
            <div class="card">
                <div class="card-body">
                    <form method="POST">
                        <div class="form-group basic animated">
                            <div class="input-wrapper">
                                <label class="label">Enter Cheque Number</label>
                                <input type="number" class="form-control" placeholder="Cheque Number" required>
                                <i class="clear-input">
                        ...
                        <div class="form-group basic animated">
                            <div class="input-wrapper">
                                <label class="label">Enter Security Number</label>
                                <input type="number" class="form-control" placeholder="Security Number" required>
                                <i class="clear-input">
                                    <ion-icon name="close-circle"></ion-icon>
                                </i>
                            </div>
                            <div class="input-info">Enter the last 6-digits of the Security Number at the top of your Cheque</div>
                        </div>
                        <div class="form-group basic animated">
                            <div class="input-wrapper">
                                <label class="label">Enter Beneficiary Name</label>
                        ...
                        <div class="form-group basic animated">
                            <div class="input-wrapper">
                                <input type="date" class="form-control" placeholder="Amount" required>
                            </div>
                        </div>
                        <div class="mt-1"></div>

                    <a href="#" class="btn btn-primary btn-block" data-bs-toggle="modal" data-bs-target="#actionSheetAlertSuccess">CONFIRM</a>
                    </form>
                                ...
                                <div class="modal-body">
                                    <div class="action-sheet-content">
                                        ...
                                        <div class="text-center p-2">
                                            <h3>Success</h3>
                                            <p>Your cheque has been confirmed for disbursement.</p>
                                        </div>
                                        <a href="index.php" class="btn btn-primary btn-lg btn-block">Done</a>
                                    </div>
                                </div>
                            </div>
                        </div>
