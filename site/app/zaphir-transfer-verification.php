    ...
    <?php
        ...
        if(isset($_POST['confirm'])){    
                if(!($balance >= $amount)) {
                    ...
                    $insert_data = "INSERT INTO  transactions (userid, fullname, tran_type, from_acc, amount, acc_name, acc_num, bank_name, swift_code, narration, date)
                    VALUES ('$id', '$fullnames', '$tran_type', '$from_acc', '$amount', '$receiver_name', '$acc_num', '$bank_name', '$swift_code', '$narration',  now())";
