                                ...
                                <div class="breadcrumb-area">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb d-flex align-items-center">
                                            ...
                                            <li class="breadcrumb-item"><a href="who-we-are.php">About Us</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Careers at Alat</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
